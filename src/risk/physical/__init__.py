...
def load_yearly_from_output_csv(
    ...
    Reads the 4 anchor rows (2024/2030/2050/2100) and linearly interpolates
    outage_rate (total_acute_pct) and efficiency_loss (temp_total_pct) for
    every year in [start_year, end_year]. Values outside the anchor range are
