    ...
    <>
      <div className="mb-8">
        ...
        <p className="text-sm text-slate-500 mt-1">
          Detailed comparison across {scenarios.length} climate/transition risk scenarios
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        ...
        {/* CRP Chart */}
        <div className="bg-white rounded-lg shadow-sm p-6">
          <h2 className="text-lg font-semibold text-slate-800 mb-4">Climate Risk Premium (bps)</h2>
      ...
      <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
        ...
        <p className="text-xs text-slate-500 mb-4">
          Scenario grouping by resulting credit rating (KIS methodology)
        </p>
        <RatingDistribution data={scenarios} />
      </div>
